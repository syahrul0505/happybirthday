            ...
            <div class="card-body">
                <form action="{{ route('homes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="phone" value="{{ old('phone') }}" class="form-control" placeholder="phone" id="phone" aria-describedby="phone">
                            </div>
                            @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="" style="border-radius:0px 0px 15px 15px;">
                        <a class="btn btn-danger" href="{{ route('homes.index') }}">
                            Back
                        </a>
