                    ...
                    <div class="card-header bg-card-head" style="border-radius:15px 15px 0px 0px;">
                        <div class="row">
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                <a href="{{ route('homes.create') }}" class="btn btn-sm btn-info me-2" style="padding: 0.4rem;">
                                ...
                                <table id="dataTable" class="table border text-nowrap customize-table mb-0 align-middle">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $home->phone ?? '' }}</td>
                                        <td>
                                          <img src="{{ asset('assets/images/home/'.($home->image ?? 'user.jpg')) }}" width="39"height="39" class="rounded-circle me-n2 card-hover border border-2 border-white">
                                        </td>
                                    </tr>
                                    @endforeach
                                  </tbody>
