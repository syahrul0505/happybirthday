...
class Home3Controller extends Controller
{
    public function index()
    {
        ...
        $data['homes'] = Home3::orderby('id', 'asc')->get();
        
        return view('backend.home.home3.index', $data); 
    }
    ...
    public function create()
    {
        ...
        return view('backend.home.home3.create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                $destinationPath = public_path('assets/images/home3/');
            ...
            return redirect()->route('homes3.index')->with(['success' => 'home added successfully!']);
        } catch (\Throwable $th) {
